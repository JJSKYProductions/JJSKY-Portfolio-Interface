    ...
    <div class="about-display-block">
      ...
      <div class="about-grid">
        <div class="about-card">
          <img src="Styles/Icons/graphic-design-01.png" alt="" class="about-icon">
        ...
        <div class="about-card">
          <img src="Styles/Icons/Animation-01.png" alt="" class="about-icon">
          <h2>ANIMATION</h2>
          <p>
        ...
        <div class="about-card">
          <img src="Styles/Icons/3d-modeling-01.png" alt="" class="about-icon">
          <h1>3D MODELLING</h1>
          <p>
      ...
      <div class="about-grid">
        ...
        <div class="about-card">
          <img src="Styles/Icons/Website-01.png" alt="" class="about-icon">
