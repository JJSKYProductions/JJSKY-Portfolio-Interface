...
logoDesignButton.addEventListener('click', () => {
  ...
  renderLogoHTML.innerHTML = `
    <div class="logo-design-display-block">
      ...
      <div class="logo-grid">
        <div class="logo-card">
          <img src="Logos/Aquarious-logo-01.png" alt="" class="logo-image">
        ...
        <div class="logo-card">
          <img src="Logos/Capricorn-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
      ...
      <div class="logo-grid">
        <div class="logo-card">
          <img src="Logos/virgo-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
            <h2>VIRGO SYMBOL</h2>
        ...
        <div class="logo-card">
          <img src="Logos/Freekleesh-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
      ...
      <div class="logo-grid">
        <div class="logo-card">
          <img src="Logos/KI-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
        ...
        <div class="logo-card">
          <img src="Logos/Cupcake-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
      ...
      <div class="logo-grid">
        ...
        <div class="logo-card">
          <img src="Logos/Maria-bt-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
            <h2>MARIA BT LOGO</h2>
      ...
      <div class="logo-grid">
        ...
        <div class="logo-card">
          <img src="Logos/Medicorp-logo-01.png" alt="" class="logo-image">
          <div class="logo-discription">
